...
-- Dumping database structure for bagisto
CREATE DATABASE IF NOT EXISTS `bagisto` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bagisto`;

-- Dumping structure for table bagisto.addresses
...
-- Dumping data for table bagisto.addresses: ~0 rows (approximately)

-- Dumping structure for table bagisto.admin_password_resets
...
-- Dumping data for table bagisto.admin_password_resets: ~0 rows (approximately)

-- Dumping structure for table bagisto.admins
...
-- Dumping data for table bagisto.admins: ~2 rows (approximately)
...
-- Dumping structure for table bagisto.attribute_families
...
-- Dumping data for table bagisto.attribute_families: ~1 rows (approximately)
INSERT INTO `attribute_families` (`id`, `code`, `name`, `status`, `is_user_defined`) VALUES
	(1, 'default', 'Default', 0, 1);

-- Dumping structure for table bagisto.attribute_group_mappings
...
-- Dumping data for table bagisto.attribute_group_mappings: ~27 rows (approximately)
...
-- Dumping structure for table bagisto.attribute_groups
...
-- Dumping data for table bagisto.attribute_groups: ~5 rows (approximately)
...
-- Dumping structure for table bagisto.attribute_option_translations
...
-- Dumping data for table bagisto.attribute_option_translations: ~9 rows (approximately)
...
-- Dumping structure for table bagisto.attribute_options
...
-- Dumping data for table bagisto.attribute_options: ~9 rows (approximately)
...
-- Dumping structure for table bagisto.attribute_translations
...
-- Dumping data for table bagisto.attribute_translations: ~27 rows (approximately)
...
-- Dumping structure for table bagisto.attributes
...
-- Dumping data for table bagisto.attributes: ~27 rows (approximately)
...
-- Dumping structure for table bagisto.booking_product_appointment_slots
...
-- Dumping data for table bagisto.booking_product_appointment_slots: ~0 rows (approximately)

-- Dumping structure for table bagisto.booking_product_default_slots
...
-- Dumping data for table bagisto.booking_product_default_slots: ~0 rows (approximately)

-- Dumping structure for table bagisto.booking_product_event_ticket_translations
...
-- Dumping data for table bagisto.booking_product_event_ticket_translations: ~0 rows (approximately)

-- Dumping structure for table bagisto.booking_product_event_tickets
...
-- Dumping data for table bagisto.booking_product_event_tickets: ~0 rows (approximately)

-- Dumping structure for table bagisto.booking_product_rental_slots
...
-- Dumping data for table bagisto.booking_product_rental_slots: ~0 rows (approximately)

-- Dumping structure for table bagisto.booking_product_table_slots
...
-- Dumping data for table bagisto.booking_product_table_slots: ~0 rows (approximately)

-- Dumping structure for table bagisto.booking_products
...
-- Dumping data for table bagisto.booking_products: ~0 rows (approximately)

-- Dumping structure for table bagisto.bookings
...
-- Dumping data for table bagisto.bookings: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart
...
-- Dumping data for table bagisto.cart: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_item_inventories
...
-- Dumping data for table bagisto.cart_item_inventories: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_items
...
-- Dumping data for table bagisto.cart_items: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_payment
...
-- Dumping data for table bagisto.cart_payment: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_rule_channels
...
-- Dumping data for table bagisto.cart_rule_channels: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_rule_coupon_usage
...
-- Dumping data for table bagisto.cart_rule_coupon_usage: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_rule_coupons
...
-- Dumping data for table bagisto.cart_rule_coupons: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_rule_customer_groups
...
-- Dumping data for table bagisto.cart_rule_customer_groups: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_rule_customers
...
-- Dumping data for table bagisto.cart_rule_customers: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_rule_translations
...
-- Dumping data for table bagisto.cart_rule_translations: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_rules
...
-- Dumping data for table bagisto.cart_rules: ~0 rows (approximately)

-- Dumping structure for table bagisto.cart_shipping_rates
...
-- Dumping data for table bagisto.cart_shipping_rates: ~0 rows (approximately)

-- Dumping structure for table bagisto.catalog_rule_channels
...
-- Dumping data for table bagisto.catalog_rule_channels: ~0 rows (approximately)

-- Dumping structure for table bagisto.catalog_rule_customer_groups
...
-- Dumping data for table bagisto.catalog_rule_customer_groups: ~0 rows (approximately)

-- Dumping structure for table bagisto.catalog_rule_product_prices
...
-- Dumping data for table bagisto.catalog_rule_product_prices: ~0 rows (approximately)

-- Dumping structure for table bagisto.catalog_rule_products
...
-- Dumping data for table bagisto.catalog_rule_products: ~0 rows (approximately)

-- Dumping structure for table bagisto.catalog_rules
...
-- Dumping data for table bagisto.catalog_rules: ~0 rows (approximately)

-- Dumping structure for table bagisto.categories
...
-- Dumping data for table bagisto.categories: ~4 rows (approximately)
INSERT INTO `categories` (`id`, `position`, `image`, `status`, `_lft`, `_rgt`, `parent_id`, `created_at`, `updated_at`, `display_mode`, `category_icon_path`, `additional`) VALUES
	...
	(2, 1, NULL, 1, 2, 3, 1, '2026-08-04 23:29:33', '2026-08-04 23:29:33', 'products_and_description', NULL, NULL),
	(3, 1, NULL, 1, 4, 5, 1, '2026-08-04 23:29:33', '2026-08-04 23:29:33', 'products_and_description', NULL, NULL),
	(4, 1, NULL, 1, 6, 7, 1, '2026-08-04 23:29:33', '2026-08-04 23:29:33', 'products_and_description', NULL, NULL);

-- Dumping structure for table bagisto.category_filterable_attributes
...
-- Dumping data for table bagisto.category_filterable_attributes: ~0 rows (approximately)

-- Dumping structure for table bagisto.category_translations
...
-- Dumping data for table bagisto.category_translations: ~8 rows (approximately)
INSERT INTO `category_translations` (`id`, `name`, `slug`, `description`, `meta_title`, `meta_description`, `meta_keywords`, `category_id`, `locale`, `locale_id`, `url_path`) VALUES
	...
	(11, 'Electronics', 'electronics', 'Electronic gadgets and accessories', '', '', '', 2, 'en', NULL, 'electronics'),
	(12, 'Fashion', 'fashion', 'Clothing, footwear and accessories', '', '', '', 3, 'en', NULL, 'fashion'),
	(13, 'Home & Living', 'home-living', 'Furniture and home decor', '', '', '', 4, 'en', NULL, 'home-living');

-- Dumping structure for table bagisto.channel_currencies
...
-- Dumping data for table bagisto.channel_currencies: ~1 rows (approximately)
INSERT INTO `channel_currencies` (`channel_id`, `currency_id`) VALUES
	(1, 1);

-- Dumping structure for table bagisto.channel_inventory_sources
...
-- Dumping data for table bagisto.channel_inventory_sources: ~1 rows (approximately)
INSERT INTO `channel_inventory_sources` (`channel_id`, `inventory_source_id`) VALUES
	(1, 1);

-- Dumping structure for table bagisto.channel_locales
...
-- Dumping data for table bagisto.channel_locales: ~1 rows (approximately)
INSERT INTO `channel_locales` (`channel_id`, `locale_id`) VALUES
	(1, 1);

-- Dumping structure for table bagisto.channel_translations
...
-- Dumping data for table bagisto.channel_translations: ~5 rows (approximately)
...
-- Dumping structure for table bagisto.channels
...
-- Dumping data for table bagisto.channels: ~1 rows (approximately)
...
-- Dumping structure for table bagisto.cms_page_channels
...
-- Dumping data for table bagisto.cms_page_channels: ~0 rows (approximately)

-- Dumping structure for table bagisto.cms_page_translations
...
-- Dumping data for table bagisto.cms_page_translations: ~11 rows (approximately)
...
-- Dumping structure for table bagisto.cms_pages
...
-- Dumping data for table bagisto.cms_pages: ~11 rows (approximately)
...
-- Dumping structure for table bagisto.core_config
...
-- Dumping data for table bagisto.core_config: ~53 rows (approximately)
...
-- Dumping structure for table bagisto.countries
...
-- Dumping data for table bagisto.countries: ~255 rows (approximately)
...
-- Dumping structure for table bagisto.country_state_translations
...
-- Dumping data for table bagisto.country_state_translations: ~2,290 rows (approximately)
...
-- Dumping structure for table bagisto.country_states
...
-- Dumping data for table bagisto.country_states: ~586 rows (approximately)
...
-- Dumping structure for table bagisto.country_translations
...
-- Dumping data for table bagisto.country_translations: ~1,020 rows (approximately)
...
-- Dumping structure for table bagisto.currencies
...
-- Dumping data for table bagisto.currencies: ~2 rows (approximately)
INSERT INTO `currencies` (`id`, `code`, `name`, `created_at`, `updated_at`, `symbol`) VALUES
	(1, 'USD', 'US Dollar', NULL, NULL, '$'),
	(2, 'EUR', 'Euro', NULL, NULL, '€'),
	(3, 'INR', 'Indian', '2026-08-09 18:24:17', '2026-08-09 18:24:17', 'Rs.');

-- Dumping structure for table bagisto.currency_exchange_rates
...
-- Dumping data for table bagisto.currency_exchange_rates: ~0 rows (approximately)

-- Dumping structure for table bagisto.customer_groups
...
-- Dumping data for table bagisto.customer_groups: ~3 rows (approximately)
...
-- Dumping structure for table bagisto.customer_password_resets
...
-- Dumping data for table bagisto.customer_password_resets: ~0 rows (approximately)

-- Dumping structure for table bagisto.customer_social_accounts
...
-- Dumping data for table bagisto.customer_social_accounts: ~0 rows (approximately)

-- Dumping structure for table bagisto.customers
...
-- Dumping data for table bagisto.customers: ~0 rows (approximately)

-- Dumping structure for table bagisto.downloadable_link_purchased
...
-- Dumping data for table bagisto.downloadable_link_purchased: ~0 rows (approximately)

-- Dumping structure for table bagisto.failed_jobs
...
-- Dumping data for table bagisto.failed_jobs: ~0 rows (approximately)

-- Dumping structure for function bagisto.get_url_path_of_category
DELIMITER //
...
-- Dumping structure for table bagisto.hws_attendance
CREATE TABLE IF NOT EXISTS `hws_attendance` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `check_in_selfie_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `check_out_time` datetime DEFAULT NULL,
  `check_out_lat` decimal(10,7) DEFAULT NULL,
  `check_out_lng` decimal(10,7) DEFAULT NULL,
  `check_out_selfie_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping data for table bagisto.hws_attendance: ~1 rows (approximately)
...
-- Dumping structure for table bagisto.hws_expense_claims
CREATE TABLE IF NOT EXISTS `hws_expense_claims` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `employee_id` bigint unsigned NOT NULL,
...
-- Dumping data for table bagisto.hws_expense_claims: ~0 rows (approximately)

-- Dumping structure for table bagisto.hws_site_surveys
CREATE TABLE IF NOT EXISTS `hws_site_surveys` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `task_id` bigint unsigned DEFAULT NULL,
  `customer_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_address` text COLLATE utf8mb4_unicode_ci,
  `property_type` enum('hotel','hospital','bungalow','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other',
  `floors` int unsigned DEFAULT NULL,
  `built_up_area_sqft` int unsigned DEFAULT NULL,
  `rooms_units` int unsigned DEFAULT NULL,
  `water_use_kld` decimal(8,2) DEFAULT NULL,
  `water_source` enum('municipal','borewell','tanker','river') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `wastewater_disposal` enum('septic_tank','open_drain','existing_stp','none') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `space_available` enum('open_area','limited','basement_only','not_sure') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
...
-- Dumping data for table bagisto.hws_site_surveys: ~3 rows (approximately)
INSERT INTO `hws_site_surveys` (`id`, `task_id`, `customer_name`, `customer_phone`, `customer_address`, `property_type`, `floors`, `built_up_area_sqft`, `rooms_units`, `water_use_kld`, `water_source`, `wastewater_disposal`, `space_available`, `notes`, `follow_up_date`, `photos`, `status`, `latitude`, `longitude`, `created_at`, `updated_at`) VALUES
	(1, 3, NULL, NULL, NULL, 'hotel', NULL, NULL, NULL, NULL, 'municipal', 'septic_tank', 'open_area', 'Interested in replacing a 12-year-old STP. Decision maker available after 4pm.', '2026-08-09', NULL, 'submitted', 8.2551200, 86.6609310, '2026-08-12 11:00:46', '2026-08-12 11:00:46'),
	(2, NULL, 'Syncack Software Company', '09602124449', 'wdwq\nAnanad Vihar, Tekri', 'hotel', 1, 12121, 22, 19.00, 'borewell', 'open_drain', 'basement_only', 'Interested in replacing a 12-year-old STP. Decision maker available after 4pm.', '2026-08-09', '["http://127.0.0.1:8000/storage/tasks/photos/6a7c076888fde.png"]', 'submitted', 8.2551200, 86.6609310, '2026-08-12 11:10:56', '2026-08-12 11:10:56'),
	(3, NULL, 'Syncack Software Company', '09602124449', 'wdwq\nAnanad Vihar, Tekri', 'bungalow', NULL, NULL, NULL, NULL, 'municipal', 'septic_tank', 'open_area', 'Interested in replacing a 12-year-old STP. Decision maker available after 4pm.', '2026-08-09', '["http://127.0.0.1:8000/storage/tasks/photos/6a7c07b52d89c.png"]', 'submitted', 8.2551200, 86.6609310, '2026-08-12 11:11:33', '2026-08-12 11:12:13');

-- Dumping structure for table bagisto.hws_survey_inquiry_types
CREATE TABLE IF NOT EXISTS `hws_survey_inquiry_types` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `survey_id` bigint unsigned NOT NULL,
  `inquiry_type` enum('stp','wtp','etp','ro_plant','softener','amc_only') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping data for table bagisto.hws_survey_inquiry_types: ~0 rows (approximately)
...
-- Dumping structure for table bagisto.hws_task_materials
CREATE TABLE IF NOT EXISTS `hws_task_materials` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table bagisto.hws_task_materials: ~0 rows (approximately)
...
-- Dumping structure for table bagisto.hws_task_photos
CREATE TABLE IF NOT EXISTS `hws_task_photos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `task_id` bigint unsigned NOT NULL,
  `type` enum('before','after','survey_site') COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table bagisto.hws_task_photos: ~0 rows (approximately)
...
-- Dumping structure for table bagisto.hws_tasks
CREATE TABLE IF NOT EXISTS `hws_tasks` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `task_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('installation','amc_service','complaint','service','sales_visit','site_survey') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `priority` enum('urgent','high','normal','low') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `step` tinyint unsigned NOT NULL DEFAULT '0',
  `scheduled_at` datetime DEFAULT NULL,
  `assigned_to` bigint unsigned DEFAULT NULL,
  `work_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  KEY `idx_amc_renewal_date` (`amc_renewal_date`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table bagisto.hws_tasks: ~0 rows (approximately)
INSERT INTO `hws_tasks` (`id`, `task_no`, `type`, `customer_name`, `customer_phone`, `customer_address`, `priority`, `step`, `scheduled_at`, `assigned_to`, `work_description`, `signature_path`, `rating`, `sale_amount`, `amc_renewal_date`, `created_at`, `updated_at`) VALUES
	(1, 'TSK-1024', 'service', 'John Doe', '9876543210', '123, Rajpur Road, Dehradun', 'normal', 4, '2026-08-08 18:40:04', 3, 'RO membrane replacement and full system service. Water quality tested — TDS reduced from 180 to 12 ppm.', 'tasks/signatures/6a772e1d47821.png', 0, NULL, NULL, '2026-08-08 18:40:04', '2026-08-08 18:54:45'),
	(2, 'TSK-3048', 'installation', 'Hotel Premium', '8888888888', 'Mussoorie Diversion, Dehradun', 'urgent', 1, '2026-08-08 20:40:04', 3, NULL, NULL, NULL, NULL, NULL, '2026-08-08 18:40:04', '2026-08-08 19:03:36'),
	(3, 'SRV-0512', 'site_survey', 'Royal Hospital', '9999999999', 'ISBT Road, Dehradun', 'high', 4, '2026-08-09 18:40:04', 3, NULL, NULL, NULL, NULL, NULL, '2026-08-08 18:40:04', '2026-08-12 11:00:47');

-- Dumping structure for table bagisto.inventory_sources
...
-- Dumping data for table bagisto.inventory_sources: ~1 rows (approximately)
...
-- Dumping structure for table bagisto.invoice_items
...
-- Dumping data for table bagisto.invoice_items: ~0 rows (approximately)

-- Dumping structure for table bagisto.invoices
...
-- Dumping data for table bagisto.invoices: ~0 rows (approximately)

-- Dumping structure for table bagisto.jobs
...
-- Dumping data for table bagisto.jobs: ~0 rows (approximately)

-- Dumping structure for table bagisto.locales
...
-- Dumping data for table bagisto.locales: ~5 rows (approximately)
...
-- Dumping structure for table bagisto.marketing_campaigns
...
-- Dumping data for table bagisto.marketing_campaigns: ~0 rows (approximately)

-- Dumping structure for table bagisto.marketing_events
...
-- Dumping data for table bagisto.marketing_events: ~0 rows (approximately)
INSERT INTO `marketing_events` (`id`, `name`, `description`, `date`, `created_at`, `updated_at`) VALUES
	(1, 'Birthday', 'Birthday', NULL, NULL, NULL);

-- Dumping structure for table bagisto.marketing_templates
...
-- Dumping data for table bagisto.marketing_templates: ~0 rows (approximately)

-- Dumping structure for table bagisto.migrations
...
-- Dumping data for table bagisto.migrations: ~218 rows (approximately)
...
-- Dumping structure for table bagisto.notifications
...
-- Dumping data for table bagisto.notifications: ~0 rows (approximately)

-- Dumping structure for table bagisto.order_brands
...
-- Dumping data for table bagisto.order_brands: ~0 rows (approximately)

-- Dumping structure for table bagisto.order_comments
...
-- Dumping data for table bagisto.order_comments: ~0 rows (approximately)

-- Dumping structure for table bagisto.order_items
...
-- Dumping data for table bagisto.order_items: ~0 rows (approximately)

-- Dumping structure for table bagisto.order_payment
...
-- Dumping data for table bagisto.order_payment: ~0 rows (approximately)

-- Dumping structure for table bagisto.order_transactions
...
-- Dumping data for table bagisto.order_transactions: ~0 rows (approximately)

-- Dumping structure for table bagisto.orders
...
-- Dumping data for table bagisto.orders: ~0 rows (approximately)

-- Dumping structure for table bagisto.password_resets
...
-- Dumping data for table bagisto.password_resets: ~0 rows (approximately)

-- Dumping structure for table bagisto.personal_access_tokens
...
-- Dumping data for table bagisto.personal_access_tokens: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_attribute_values
...
-- Dumping data for table bagisto.product_attribute_values: ~88 rows (approximately)
INSERT INTO `product_attribute_values` (`id`, `locale`, `channel`, `text_value`, `boolean_value`, `integer_value`, `float_value`, `datetime_value`, `date_value`, `json_value`, `product_id`, `attribute_id`) VALUES
	(1, 'en', 'default', 'Comfortable over-ear wireless headphones with noise cancellation.', NULL, NULL, NULL, NULL, NULL, NULL, 1, 9),
	(2, 'en', 'default', 'Comfortable over-ear wireless headphones with noise cancellation.', NULL, NULL, NULL, NULL, NULL, NULL, 1, 10),
	(3, 'en', 'default', 'Wireless Headphones', NULL, NULL, NULL, NULL, NULL, NULL, 1, 2),
	(4, NULL, NULL, 'wireless-headphones-1', NULL, NULL, NULL, NULL, NULL, NULL, 1, 3),
	(5, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1, 5),
	(6, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 1, 6),
	(7, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 1, 7),
	(8, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 1, 8),
	(9, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1, 26),
	(10, NULL, NULL, NULL, NULL, NULL, 59.9900, NULL, NULL, NULL, 1, 11),
	(11, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 1, 22),
	(12, 'en', 'default', 'Feature-packed smart watch with heart-rate and sleep tracking.', NULL, NULL, NULL, NULL, NULL, NULL, 2, 9),
	(13, 'en', 'default', 'Feature-packed smart watch with heart-rate and sleep tracking.', NULL, NULL, NULL, NULL, NULL, NULL, 2, 10),
	(14, 'en', 'default', 'Smart Watch', NULL, NULL, NULL, NULL, NULL, NULL, 2, 2),
	(15, NULL, NULL, 'smart-watch-2', NULL, NULL, NULL, NULL, NULL, NULL, 2, 3),
	(16, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 2, 5),
	(17, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 2, 6),
	(18, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 2, 7),
	(19, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 2, 8),
	(20, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 2, 26),
	(21, NULL, NULL, NULL, NULL, NULL, 129.9900, NULL, NULL, NULL, 2, 11),
	(22, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 2, 22),
	(23, 'en', 'default', 'Portable Bluetooth speaker with rich bass and 12-hour battery life.', NULL, NULL, NULL, NULL, NULL, NULL, 3, 9),
	(24, 'en', 'default', 'Portable Bluetooth speaker with rich bass and 12-hour battery life.', NULL, NULL, NULL, NULL, NULL, NULL, 3, 10),
	(25, 'en', 'default', 'Bluetooth Speaker', NULL, NULL, NULL, NULL, NULL, NULL, 3, 2),
	(26, NULL, NULL, 'bluetooth-speaker-3', NULL, NULL, NULL, NULL, NULL, NULL, 3, 3),
	(27, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 3, 5),
	(28, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 3, 6),
	(29, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 3, 7),
	(30, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 3, 8),
	(31, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 3, 26),
	(32, NULL, NULL, NULL, NULL, NULL, 39.9900, NULL, NULL, NULL, 3, 11),
	(33, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 3, 22),
	(34, 'en', 'default', 'Soft, breathable cotton t-shirt, available in multiple colors.', NULL, NULL, NULL, NULL, NULL, NULL, 4, 9),
	(35, 'en', 'default', 'Soft, breathable cotton t-shirt, available in multiple colors.', NULL, NULL, NULL, NULL, NULL, NULL, 4, 10),
	(36, 'en', 'default', 'Men\'s Cotton T-Shirt', NULL, NULL, NULL, NULL, NULL, NULL, 4, 2),
	(37, NULL, NULL, 'mens-cotton-t-shirt-4', NULL, NULL, NULL, NULL, NULL, NULL, 4, 3),
	(38, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 4, 5),
	(39, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 4, 6),
	(40, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 4, 7),
	(41, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 4, 8),
	(42, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 4, 26),
	(43, NULL, NULL, NULL, NULL, NULL, 19.9900, NULL, NULL, NULL, 4, 11),
	(44, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 4, 22),
	(45, 'en', 'default', 'Stylish faux-leather handbag with adjustable strap.', NULL, NULL, NULL, NULL, NULL, NULL, 5, 9),
	(46, 'en', 'default', 'Stylish faux-leather handbag with adjustable strap.', NULL, NULL, NULL, NULL, NULL, NULL, 5, 10),
	(47, 'en', 'default', 'Women\'s Handbag', NULL, NULL, NULL, NULL, NULL, NULL, 5, 2),
	(48, NULL, NULL, 'womens-handbag-5', NULL, NULL, NULL, NULL, NULL, NULL, 5, 3),
	(49, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 5, 5),
	(50, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 5, 6),
	(51, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 5, 7),
	(52, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 5, 8),
	(53, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 5, 26),
	(54, NULL, NULL, NULL, NULL, NULL, 49.9900, NULL, NULL, NULL, 5, 11),
	(55, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 5, 22),
	(56, 'en', 'default', 'Lightweight running shoes with cushioned sole.', NULL, NULL, NULL, NULL, NULL, NULL, 6, 9),
	(57, 'en', 'default', 'Lightweight running shoes with cushioned sole.', NULL, NULL, NULL, NULL, NULL, NULL, 6, 10),
	(58, 'en', 'default', 'Running Shoes', NULL, NULL, NULL, NULL, NULL, NULL, 6, 2),
	(59, NULL, NULL, 'running-shoes-6', NULL, NULL, NULL, NULL, NULL, NULL, 6, 3),
	(60, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 6, 5),
	(61, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 6, 6),
	(62, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 6, 7),
	(63, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 6, 8),
	(64, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 6, 26),
	(65, NULL, NULL, NULL, NULL, NULL, 79.9900, NULL, NULL, NULL, 6, 11),
	(66, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 6, 22),
	(67, 'en', 'default', 'Hand-finished ceramic vase, perfect for any room.', NULL, NULL, NULL, NULL, NULL, NULL, 7, 9),
	(68, 'en', 'default', 'Hand-finished ceramic vase, perfect for any room.', NULL, NULL, NULL, NULL, NULL, NULL, 7, 10),
	(69, 'en', 'default', 'Ceramic Vase', NULL, NULL, NULL, NULL, NULL, NULL, 7, 2),
	(70, NULL, NULL, 'ceramic-vase-7', NULL, NULL, NULL, NULL, NULL, NULL, 7, 3),
	(71, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 7, 5),
	(72, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 7, 6),
	(73, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 7, 7),
	(74, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 7, 8),
	(75, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 7, 26),
	(76, NULL, NULL, NULL, NULL, NULL, 24.9900, NULL, NULL, NULL, 7, 11),
	(77, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 7, 22),
	(78, 'en', 'default', 'Modern table lamp with warm ambient lighting.', NULL, NULL, NULL, NULL, NULL, NULL, 8, 9),
	(79, 'en', 'default', 'Modern table lamp with warm ambient lighting.', NULL, NULL, NULL, NULL, NULL, NULL, 8, 10),
	(80, 'en', 'default', 'Table Lamp', NULL, NULL, NULL, NULL, NULL, NULL, 8, 2),
	(81, NULL, NULL, 'table-lamp-8', NULL, NULL, NULL, NULL, NULL, NULL, 8, 3),
	(82, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 8, 5),
	(83, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 8, 6),
	(84, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 8, 7),
	(85, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 8, 8),
	(86, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 8, 26),
	(87, NULL, NULL, NULL, NULL, NULL, 34.9900, NULL, NULL, NULL, 8, 11),
	(88, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, 8, 22);

-- Dumping structure for table bagisto.product_bundle_option_products
...
-- Dumping data for table bagisto.product_bundle_option_products: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_bundle_option_translations
...
-- Dumping data for table bagisto.product_bundle_option_translations: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_bundle_options
...
-- Dumping data for table bagisto.product_bundle_options: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_categories
...
-- Dumping data for table bagisto.product_categories: ~8 rows (approximately)
...
-- Dumping structure for table bagisto.product_cross_sells
...
-- Dumping data for table bagisto.product_cross_sells: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_customer_group_prices
...
-- Dumping data for table bagisto.product_customer_group_prices: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_downloadable_link_translations
...
-- Dumping data for table bagisto.product_downloadable_link_translations: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_downloadable_links
...
-- Dumping data for table bagisto.product_downloadable_links: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_downloadable_sample_translations
...
-- Dumping data for table bagisto.product_downloadable_sample_translations: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_downloadable_samples
...
-- Dumping data for table bagisto.product_downloadable_samples: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_flat
...
-- Dumping data for table bagisto.product_flat: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_grouped_products
...
-- Dumping data for table bagisto.product_grouped_products: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_images
...
-- Dumping data for table bagisto.product_images: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_inventories
...
-- Dumping data for table bagisto.product_inventories: ~8 rows (approximately)
...
-- Dumping structure for table bagisto.product_ordered_inventories
...
-- Dumping data for table bagisto.product_ordered_inventories: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_relations
...
-- Dumping data for table bagisto.product_relations: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_review_images
...
-- Dumping data for table bagisto.product_review_images: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_reviews
...
-- Dumping data for table bagisto.product_reviews: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_super_attributes
...
-- Dumping data for table bagisto.product_super_attributes: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_up_sells
...
-- Dumping data for table bagisto.product_up_sells: ~0 rows (approximately)

-- Dumping structure for table bagisto.product_videos
...
-- Dumping data for table bagisto.product_videos: ~0 rows (approximately)

-- Dumping structure for table bagisto.products
...
-- Dumping data for table bagisto.products: ~8 rows (approximately)
INSERT INTO `products` (`id`, `sku`, `type`, `created_at`, `updated_at`, `parent_id`, `attribute_family_id`, `additional`) VALUES
	(1, 'ELEC-HEADPHONE-001', 'simple', '2026-08-04 23:29:36', '2026-08-04 23:29:36', NULL, 1, NULL),
	(2, 'ELEC-WATCH-001', 'simple', '2026-08-04 23:29:40', '2026-08-04 23:29:40', NULL, 1, NULL),
	(3, 'ELEC-SPEAKER-001', 'simple', '2026-08-04 23:29:43', '2026-08-04 23:29:43', NULL, 1, NULL),
	(4, 'FASH-TSHIRT-001', 'simple', '2026-08-04 23:29:46', '2026-08-04 23:29:46', NULL, 1, NULL),
	(5, 'FASH-HANDBAG-001', 'simple', '2026-08-04 23:29:49', '2026-08-04 23:29:49', NULL, 1, NULL),
	(6, 'FASH-SHOES-001', 'simple', '2026-08-04 23:29:52', '2026-08-04 23:29:52', NULL, 1, NULL),
	(7, 'HOME-VASE-001', 'simple', '2026-08-04 23:29:55', '2026-08-04 23:29:55', NULL, 1, NULL),
	(8, 'HOME-LAMP-001', 'simple', '2026-08-04 23:29:58', '2026-08-04 23:29:58', NULL, 1, NULL);

-- Dumping structure for table bagisto.push_notification_translations
CREATE TABLE IF NOT EXISTS `push_notification_translations` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `title` text COLLATE utf8mb4_unicode_ci,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `push_notification_translations_locale_unique` (`push_notification_id`,`locale`,`channel`),
  CONSTRAINT `push_notification_translations_push_notification_id_foreign` FOREIGN KEY (`push_notification_id`) REFERENCES `push_notifications` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table bagisto.push_notification_translations: ~0 rows (approximately)

-- Dumping structure for table bagisto.push_notifications
...
-- Dumping data for table bagisto.push_notifications: ~0 rows (approximately)

-- Dumping structure for table bagisto.refund_items
...
-- Dumping data for table bagisto.refund_items: ~0 rows (approximately)

-- Dumping structure for table bagisto.refunds
...
-- Dumping data for table bagisto.refunds: ~0 rows (approximately)

-- Dumping structure for table bagisto.roles
...
-- Dumping data for table bagisto.roles: ~1 rows (approximately)
INSERT INTO `roles` (`id`, `name`, `description`, `permission_type`, `permissions`, `created_at`, `updated_at`) VALUES
	(1, 'Administrator', 'Administrator role', 'all', NULL, NULL, NULL);

-- Dumping structure for table bagisto.shipment_items
...
-- Dumping data for table bagisto.shipment_items: ~0 rows (approximately)

-- Dumping structure for table bagisto.shipments
...
-- Dumping data for table bagisto.shipments: ~0 rows (approximately)

-- Dumping structure for table bagisto.sitemaps
...
-- Dumping data for table bagisto.sitemaps: ~0 rows (approximately)

-- Dumping structure for table bagisto.sliders
...
-- Dumping data for table bagisto.sliders: ~0 rows (approximately)

-- Dumping structure for table bagisto.subscribers_list
...
-- Dumping data for table bagisto.subscribers_list: ~0 rows (approximately)

-- Dumping structure for table bagisto.tax_categories
...
-- Dumping data for table bagisto.tax_categories: ~0 rows (approximately)

-- Dumping structure for table bagisto.tax_categories_tax_rates
...
-- Dumping data for table bagisto.tax_categories_tax_rates: ~0 rows (approximately)

-- Dumping structure for table bagisto.tax_rates
...
-- Dumping data for table bagisto.tax_rates: ~0 rows (approximately)

-- Dumping structure for table bagisto.users
...
-- Dumping data for table bagisto.users: ~0 rows (approximately)

-- Dumping structure for table bagisto.velocity_contents
...
-- Dumping data for table bagisto.velocity_contents: ~0 rows (approximately)

-- Dumping structure for table bagisto.velocity_contents_translations
...
-- Dumping data for table bagisto.velocity_contents_translations: ~0 rows (approximately)

-- Dumping structure for table bagisto.velocity_customer_compare_products
...
-- Dumping data for table bagisto.velocity_customer_compare_products: ~0 rows (approximately)

-- Dumping structure for table bagisto.velocity_meta_data
...
-- Dumping data for table bagisto.velocity_meta_data: ~1 rows (approximately)
...
-- Dumping structure for table bagisto.wishlist
...
-- Dumping data for table bagisto.wishlist: ~0 rows (approximately)

-- Dumping structure for trigger bagisto.trig_categories_insert
...
-- Dumping structure for trigger bagisto.trig_categories_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Dumping structure for trigger bagisto.trig_category_translations_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Dumping structure for trigger bagisto.trig_category_translations_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
