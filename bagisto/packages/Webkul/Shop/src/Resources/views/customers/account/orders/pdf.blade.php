...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        @php
            ...
            if (!function_exists('hws_number_to_words_shop')) {
                function hws_number_to_words_shop($number) {
                    $no = floor($number);
        ...
        <div class="tally-box">
                ...
                <tbody>
                    ...
                    @foreach ($invoice->items as $item)
                        ...
                        <tr class="item-row">
                            ...
                            <td class="text-left">
                                ...
                                <div class="item-subtext">SKU: {{ $item->child ? $item->child->sku : $item->sku }}</div>
                    ...
                    @if($isGst && $isInterState)
                        <tr class="item-row">
                            ...
                            <td class="text-center"></td>
                            <td class="text-right bold">{!! number_format($invoice->tax_amount, 2) !!}</td>
                        </tr>
                    @elseif($isGst)
                        <tr class="item-row">
                            <td></td>
                            ...
                            <td class="text-right"></td>
                            <td class="text-center"></td>
                            <td class="text-right bold">{!! number_format($invoice->tax_amount / 2, 2) !!}</td>
                        </tr>
                        <tr class="item-row">
                            <td></td>
                    ...
                    @if($invoice->shipping_amount > 0)
                        <tr class="item-row">
                            ...
                            <td class="text-right"></td>
                            <td class="text-center"></td>
                            <td class="text-right bold">{!! number_format($invoice->shipping_amount, 2) !!}</td>
                        </tr>
                    @endif
                    ...
                    @if($invoice->discount_amount > 0)
                        <tr class="item-row">
                            ...
                            <td class="text-right"></td>
                            <td class="text-center"></td>
                            <td class="text-right bold">-{!! number_format($invoice->discount_amount, 2) !!}</td>
                        </tr>
                    @endif
                    ...
                    <tr style="border-top: 1.5px solid #000000; border-bottom: 1.5px solid #000000; font-weight: bold; background: #fafafa;">
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-right bold" style="font-size: 9pt;">₹{!! number_format($invoice->grand_total, 2) !!}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="amount-words">
                ...
                <span style="font-weight: bold; text-transform: uppercase;">{{ hws_number_to_words_shop($invoice->grand_total) }}</span>
            </div>
            ...
            <div style="padding: 4px 6px;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            @elseif($isGst)
                                ...
                                <td class="text-right">{!! number_format($invoice->tax_amount / 2, 2) !!}</td>
                                <td class="text-center">9%</td>
                                <td class="text-right">{!! number_format($invoice->tax_amount / 2, 2) !!}</td>
                            @else
                                <td class="text-center">—</td>
                ...
                <div style="font-size: 7pt; margin-top: 2px;">
                    <strong>Tax Amount (in words):</strong> {{ hws_number_to_words_shop($invoice->tax_amount) }}
                </div>
            </div>
