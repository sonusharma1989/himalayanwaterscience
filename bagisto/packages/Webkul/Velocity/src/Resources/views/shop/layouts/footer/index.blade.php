...
<footer class="hws-footer">
    <div class="hws-container hws-footer__grid">
        ...
        <div><h3>Customer care</h3><ul><li><a href="{{ auth('customer')->check() ? route('hws.customer.account.tracking') : route('customer.session.index') }}">My account</a></li><li><a href="{{ route('shop.checkout.cart.index') }}">Cart</a></li><li><a href="{{ route('hws.vision') }}">Our vision</a></li><li><a href="#" data-hws-request="service">Technical support</a></li><li><a href="#" data-hws-request="service_quote">Request a quote</a></li></ul></div>
