...
<div style="padding:24px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;">

    <div style="margin-bottom:24px;">
        <h1 style="font-size:24px;font-weight:700;letter-spacing:-0.01em;color:#1e293b;margin:0 0 4px;">Admin Web</h1>
        <p style="font-size:14px;color:#64748b;margin:0;">Manager dashboard — live team status, jobs and sales at a glance.</p>
    </div>

    {{-- ── KPI cards ─────────────────────────────────────────── --}}
    <div style="display:flex;flex-wrap:wrap;gap:14px;margin-bottom:24px;">

        <div style="flex:1;min-width:150px;border:1px solid #f1f5f9;background:#fff;border-radius:16px;padding:16px;box-shadow:0 1px 2px rgba(0,0,0,0.04);">
            <div style="width:32px;height:32px;border-radius:8px;background:#eefbfb;display:flex;align-items:center;justify-content:center;margin-bottom:12px;font-size:14px;">👥</div>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:20px;margin-bottom:20px;">
        ...
        <div style="flex:2;min-width:320px;border:1px solid #f1f5f9;background:#fff;border-radius:16px;padding:20px;box-shadow:0 1px 2px rgba(0,0,0,0.04);">
            ...
            <div style="display:flex;align-items:flex-end;justify-content:space-between;gap:12px;height:160px;border-top:1px solid #f1f5f9;padding-top:16px;">
                @foreach ($weekChart as $day)
                    <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:8px;height:100%;justify-content:flex-end;">
                        <div style="width:100%;border-radius:6px 6px 0 0;background:#1d7c88;height:{{ $day['count'] > 0 ? max(($day['count'] / $maxCount) * 100, 6) : 2 }}%;" title="{{ $day['label'] }}: {{ $day['count'] }} completed"></div>
        ...
        <div style="flex:1;min-width:220px;border:1px solid #f1f5f9;background:#fff;border-radius:16px;padding:20px;box-shadow:0 1px 2px rgba(0,0,0,0.04);display:flex;flex-direction:column;">
            ...
            <div style="flex:1;display:flex;align-items:center;justify-content:center;">
                <div style="position:relative;width:128px;height:128px;">
                    <svg viewBox="0 0 120 120" width="128" height="128" style="transform:rotate(-90deg);">
                        ...
                        <circle cx="60" cy="60" r="50" fill="none" stroke="#1D7C88" stroke-width="12"
    ...
    <div style="border:1px solid #f1f5f9;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 1px 2px rgba(0,0,0,0.04);">
        <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #f1f5f9;padding:16px 20px;">
            <p style="font-size:14px;font-weight:700;color:#334155;margin:0;">Live employee status</p>
            <a href="{{ route('hws.admin.attendance.index') }}" style="font-size:12px;font-weight:600;color:#1d7c88;text-decoration:none;">View all</a>
        </div>
                        ...
                        <tr style="border-bottom:1px solid #f8fafc;">
                            <td style="padding:12px 20px;">
                                <div style="display:flex;align-items:center;gap:10px;">
                                    <div style="width:28px;height:28px;border-radius:50%;background:#eefbfb;color:#1d7c88;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;">
