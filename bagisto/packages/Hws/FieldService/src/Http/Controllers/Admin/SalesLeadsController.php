...
class SalesLeadsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $leadPageTitle = match ($leadType) {
            ...
            default => 'Trading Leads',
        };
        $leadIndexRoute = 'hws.admin.leads.' . $leadType;
        $query = SiteSurvey::with(['task', 'inquiryTypes'])
            ->where('sales_type', $leadType)
        ...
        return view('hws::admin.sales-leads.index', compact('leads', 'employees', 'leadType', 'leadPageTitle', 'leadIndexRoute'));
    }
